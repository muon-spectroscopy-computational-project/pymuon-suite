...
def vibrational_displacement_write(
    structure,
    mode_index=-1,
    mu_symbol="H:mu",
    grid_n=20,
    ...
    **kwargs
    ...
    masses[species == mu_symbol] = constants.m_mu_amu
    cell.set_masses(masses)

    # Now create the distribution scheme
    displsch = AllAtomDisplacements(
        ph_evals, ph_evecs, masses, mode_index, sigma_n
    )

    displsch.recalc_displacements(n=grid_n, T=displace_T)
    # create_displaced_cell(cell=cell, displacements=ph_evecs[mode_index])
